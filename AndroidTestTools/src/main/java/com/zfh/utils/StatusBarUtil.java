...
public class StatusBarUtil {
    ...
    /**
     * 普通没有Actionbar的Fragment设置状态样颜色，这里只是填充状态栏，颜色由Activity填充，ZFH添加
     * @param fragment
     */
    public static void resetFragmentView(Fragment fragment) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (fragment.getView() != null) fragment.getView().setPadding(0, getStatusBarHeight(fragment.getContext()), 0, 0);
        }
    }
}
